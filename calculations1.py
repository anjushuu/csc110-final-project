...
class Calculations:
    ...
    def generate_report(self) -> None:
        ...
        data = ['1. There seemed to be no correlation between '
                'acres burned and rises in annual temperature \n',
                '2. Scientists claimed that areas of typically dry '
                'climate have become drier, and similarly areas of '
                'particularly wet climate have become wetter. \n',
                '3. From the graphs, it\'s apparent that in 2018, '
                'there was a sudden spike in acres burned, most likely '
                'not induced by increasing dryness but by incident. \n'
                '4. Any active fires in California currently: '
